...
export const zkredAgentIdPlugin: Plugin = {
  ...
  tools: (context: Context) => [generateDidTool(context), getPublicKeyFromDidTool(context), createIdentityTool(context), validateAgentTool(context), verifySignatureTool(context)],
};
